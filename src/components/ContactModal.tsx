		...
		<Modal isOpen={isOpen} onClose={() => setIsOpen(false)}>
			<>
				<header className='mb-4'>
					...
					<p className='text-[#cb83a3]'>
						I’m always open to discussing new projects,
						collaboration opportunities, or creative ideas. Feel
						free to reach out — I’d love to hear from you. ✿
					</p>
				</header>
				<main className=' border-t-2 border-dashed border-[#cb83a3] py-10'>
					<section className='grid grid-rows-2 gap-10'>
						<ul className='flex items-center justify-center gap-10'>
							<li className='flex items-center gap-2'>
								...
								<a
									className='text-blue-400 hover:text-blue-600 hover:underline active:text-blue-600'
									href='tel:9527495098'
								>
									+91 95274 95098
								</a>
							...
							<li className='flex items-center gap-2'>
								...
								<a
									className='text-blue-400 hover:text-blue-600 hover:underline active:text-blue-600'
									href='mailto:ruttikajadhav@gmail.com'
								>
					...
					<section>
						<ul className='flex items-center justify-center gap-4'>
							<li>
								<a
									target='_blank'
									href='https://github.com/UntamedLotus'
								>
									<svg
										xmlns='http://www.w3.org/2000/svg'
										x='0px'
							...
							<li>
								<a
									target='_blank'
									href='https://twitter.com/Rutika37108105'
								>
									<svg
										xmlns='http://www.w3.org/2000/svg'
										x='0px'
